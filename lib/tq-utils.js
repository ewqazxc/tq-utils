(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["tqUtils"] = factory();
	else
		root["tqUtils"] = factory();
})(window, function() {
...
exports.default = {
    renderTime: exports.renderTime,
    renderDate: exports.renderDate,
    renderDateTime: exports.renderDateTime
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.compressorImageBySize = exports.compressorImage = void 0;
var image_compressor_js_1 = __importDefault(__webpack_require__(7));
exports.compressorImage = function (file, quality, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            new image_compressor_js_1.default(file, __assign(__assign({}, options), { quality: quality, success: function (result) {
...
exports.compressorImageBySize = function (file, size, maxWidth) {
    if (size === void 0) { size = 1024 * 1024; }
    if (maxWidth === void 0) { maxWidth = 960; }
    return __awaiter(void 0, void 0, void 0, function () {
        var quality, newFile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    quality = .6;
                    return [4 /*yield*/, exports.compressorImage(file, quality, { maxWidth: maxWidth })];
                case 1:
                    newFile = _a.sent();
                    _a.label = 2;
                case 2:
                    if (!(newFile.size > size && quality >= 0)) return [3 /*break*/, 5];
                    quality = Number((quality - 0.1).toFixed(1));
                    if (!(quality >= 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, exports.compressorImage(newFile, quality, { maxWidth: maxWidth })];
                case 3:
                    newFile = _a.sent();
                    _a.label = 4;
                case 4: return [3 /*break*/, 2];
                case 5:
                    if (!(newFile.size > size)) return [3 /*break*/, 8];
                    quality = Number((quality - 0.1).toFixed(1));
                    if (!(quality >= 0)) return [3 /*break*/, 7];
                    return [4 /*yield*/, exports.compressorImage(newFile, quality)];
                case 6:
                    newFile = _a.sent();
                    _a.label = 7;
                case 7: return [3 /*break*/, 5];
                case 8: return [2 /*return*/, newFile];
            }
        });
    });
};
exports.default = {
    compressorImage: exports.compressorImage,
    compressorImageBySize: exports.compressorImageBySize
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var RenderUtils = __importStar(__webpack_require__(0));
var ImageUtils = __importStar(__webpack_require__(3));
var ImageUtils_1 = __webpack_require__(3);
Object.defineProperty(exports, "ImageUtils", { enumerable: true, get: function () { return ImageUtils_1.default; } });
var RenderUtils_1 = __webpack_require__(0);
Object.defineProperty(exports, "RenderUtils", { enumerable: true, get: function () { return RenderUtils_1.default; } });
exports.default = {
